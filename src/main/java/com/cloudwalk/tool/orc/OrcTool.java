package com.cloudwalk.tool.orc;
...
public class OrcTool {
	private static final String table = "testcollectionticketocr";
	private DBHelper dbHelper;
	String root;

	public OrcTool(String url, String driver, String user, String password, String root) {
	...
	private void createTableIfNotExists(Connection conn0) {
		...
		try {
			...
			builder.append("create table testcollectionticketocr (");
