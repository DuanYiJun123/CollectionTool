package com.cloudwalk.tool.bankocrAccu;
...
public class BankOcrAccuTool {
	private static final String table = "testcollectionbankocrAccu";
	private DBHelper dbHelper;
	String root;

	public BankOcrAccuTool(String url, String driver, String user, String password, String root) {
	...
	private void createTableIfNotExists(Connection conn0) {
		...
		try {
			...
			builder.append("create table testcollectionbankocrAccu (");
	...
	private void deleteBankOcr(Connection conn) {
		try {
