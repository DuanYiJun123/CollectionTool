...
public class IDCardBackToolAccu {
	private static final String table = "testcollectionidcardbackaccu";
	private DBHelper dbHelper;
	String root;

	public IDCardBackToolAccu(String url, String driver, String user, String password, String root) {
	...
	private void createTableIfNotExists(Connection conn0) {
		...
		try {
			...
			builder.append("create table testcollectionidcardbackaccu (");
