package com.cloudwalk.tool.bankorc;
...
public class BankOcrTool {
	private static final String table = "testcollectionbankocr";
	private DBHelper dbHelper;
	String root;

	public BankOcrTool(String url, String driver, String user, String password, String root) {
	...
	private void createTableIfNotExists(Connection conn0) {
		...
		try {
			...
			builder.append("create table testcollectionbankocr (");
