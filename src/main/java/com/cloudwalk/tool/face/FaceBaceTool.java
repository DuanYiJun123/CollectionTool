...
public class FaceBaceTool {
	private static final String table = "testcollectionfacebase";
	private DBHelper dbHelper;
	String root;

	public FaceBaceTool(String url, String driver, String user, String password, String root) {
	...
	private void createTableIfNotExists(Connection conn0) {
		...
		try {
			...
			builder.append("create table testcollectionfacebase (");
