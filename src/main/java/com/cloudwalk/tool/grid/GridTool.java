package com.cloudwalk.tool.grid;
...
public class GridTool {
	private static final String table = "testcollectiongrid";
	private DBHelper dbHelper;
	String root;

	public GridTool(String url, String driver, String user, String password, String root) {
	...
	private void createTableIfNotExists(Connection conn0) {
		...
		try {
			...
			builder.append("create table testcollectiongrid (");
